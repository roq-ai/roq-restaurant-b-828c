...
export function BillingListPage(props: BillingListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBillings({
        ...
        order: params.order,
        searchTermKeys: ['oreder_summary.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'oreder_summary', header: 'Oreder Summary', accessorKey: 'oreder_summary' },
    { id: 'total_bill', header: 'total_bill', accessorKey: 'total_bill' },
