    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <TextInput
            error={formik.errors.oreder_summary}
            label={'Oreder Summary'}
            props={{
              name: 'oreder_summary',
              placeholder: 'Oreder Summary',
              value: formik.values?.oreder_summary,
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'total_bill',
              isInvalid: !!formik.errors?.total_bill,
            }}
            name="total_bill"
            error={formik.errors?.total_bill}
            value={formik.values?.total_bill}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('total_bill', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
